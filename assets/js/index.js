    ...
    (function tabsModule () {
        let servicesData = {
            service1: {
                ...
                image: "/wp-content/themes/testWP/assets/img/hair.jpg"
            },
            service2: {
                name: 'Загущение',
                text: 'Текст для Загущение',
                price: 'Стоимость от XXX лари',
                image: "/wp-content/themes/testWP/assets/img/hair2.jpg"
            },
            service3: {
                name: 'Коррекция',
                text: 'Текст для Коррекция',
                price: 'Стоимость от YYY лари',
                image: "/wp-content/themes/testWP/assets/img/hair3.jpg"
            },
            service4: {
                name: 'Снятие нарощенных волос',
                text: 'Текст для Снятие нарощенных волос',
                price: 'Стоимость от ZZZ лари',
                image: "/wp-content/themes/testWP/assets/img/hair4.jpg"
            }
        };
